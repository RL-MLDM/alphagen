...
from alphagen.rl.ppo_mask_recurrent.buffers import MRRolloutBuffer
from alphagen.rl.ppo_mask_recurrent.policies import MRActorCriticPolicy


class MRPPO(OnPolicyAlgorithm):
    """
    ...
    def __init__(
        self,
        policy: Union[str, Type[MRActorCriticPolicy]],
    ...
    def _setup_model(self) -> None:
        ...
        buffer_cls = (
            RecurrentDictRolloutBuffer if isinstance(self.observation_space, gym.spaces.Dict) else MRRolloutBuffer
        )
        ...
        if not isinstance(self.policy, MRActorCriticPolicy):
            raise ValueError("Policy must subclass MRActorCriticPolicy")
